<fieldset id="groupForm_3" class="mb-5 mt-4 border rounded-3 p-3 p-lg-5 position-relative form-section">
    <legend class="title-form w-auto rounded-2">ครูผู้ดูแลเด็กระดับมัธยมศึกษาปีที่ 1-3</legend>
    <div>
        <div class="mb-3">
