...
@section('content')
    ...
    @endphp
    <div class="bg-1 h-100 wow fadeIn fs-4">
            ...
            <div class="col-12">
                ...
                <div class="row">
                        ...
                        <div class="d-block d-lg-flex">
                            @if ($question_no == 1)
                                ...
                                <div class="flex-grow-1">
                                    <a class="btn btn-lg btn-outline-secondary rounded-pill py-2 btn_prev_quiz" href="{{ $back_url }}">
                                        <em class="fa fa-angle-left me-3"></em> ย้อนกลับ
                                    </a>
                                </div>
                            @else
                                <div class="flex-grow-1">
                                    <a class="btn btn-lg btn-outline-secondary rounded-pill py-2 btn_prev_quiz" href="{{ url('elearning/' . $user_curriculum_pp_exam->id . '/exam?q=' . ($question_no - 1)) }}">
                    ...
                    ข้อถัดไป<em class="fa fa-angle-right ms-3"></em>
                            ...
                            <button type="submit" class="btn btn-lg btn-success rounded-pill py-2 btn_next_quiz btn_submit_answer">
