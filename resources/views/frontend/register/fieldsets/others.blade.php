<fieldset id="groupForm_4" class="mb-5 mt-4 border rounded-3 p-3 p-lg-5 position-relative form-section">
    <legend class="title-form w-auto rounded-2">เจ้าหน้าที่สาธารณสุขและประชาชนทั่วไป</legend>
    <div>
        <div class="mb-3">
